 ...
 * every file.
 */
typedef char (*Plugin_Open_Next_Func) (void **plugin_data, char *filename,
 ...
 */
typedef void (*Plugin_Close_Prev_Func) (void **plugin_data, Evas *evas);
 ...
 */
typedef void (*Plugin_Show_Next_Func) (void **plugin_data,
                                       Evas_Object *main_window, Evas *evas);
 ...
 */
typedef void (*Plugin_Hide_Current_Func) (void **plugin_data,
                                          Evas_Object *main_window, Evas *evas);
